...
function populateNavBar(pokemon_page){
    ...
    //console.log("### LOGGING STRINGIFIED ###");
    //console.log(pokemon_page_stringified);
...
function loadPokemonData(obj){
    ...
    for(let i = 0; i<stats.length; i++){
        ...
        stat_list[i].style.width = `${current_stat}%`; 
    } 
    ...
    // FLAVOR TEXT
    // species < url <  flavor_text_entries[2] < flavor_text
    // if the value is set in english, add that one into the list and return the whoooole list
    
    // MAIN IMAGE
    // clear out old image and load in the main image
